...
/**
 * ClassName: SaltyfishLinearLayout<br/>
 * Description: ${TODO} <br/>
 * Date: 2016/10/2 21:07 <br/>
 * <p>
 * Author 昊<br/>
 * Version 1.0<br/>
 * since JDK 1.6<br/>
...
public class SaltyfishLinearLayout extends LinearLayout  implements TintableBackgroundView,ISaltyfishGeneralSkin {
    private SaltyfishAppCompatBackgroundHelper mBackgroundTintHelper;
    protected boolean isGeneralSkin = false;
    public SaltyfishLinearLayout(Context context) {
        this(context,null);
    }

    public SaltyfishLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SaltyfishLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
