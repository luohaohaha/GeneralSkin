...
public class RadioButtonDrawable extends Drawable implements Animatable {
	...
	private void drawChecked(Canvas canvas){
		...
		if(isRunning()){
			...
			if(mAnimProgress < inTime){
				...
				mPaint.setColor(getMiddleColor(mPrevColor, mCurColor, inProgress));
	...
	public static class Builder{
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
			...
			width(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_rbd_width, getDpToPx(context, 32)));
			height(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_rbd_height, getDpToPx(context, 32)));
			strokeSize(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_rbd_strokeSize, getDpToPx(context, 2)));
			radius(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_rbd_radius, getDpToPx(context, 10)));
			innerRadius(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_rbd_innerRadius, getDpToPx(context, 5)));
			...
			if(mStrokeColor == null){
				...
				int[] colors = new int[]{
						colorControlNormal(context, 0xFF000000),
