...
import static saltyfish.library.utils.SaltyfishUtilTool.setBackground;
...
public final class RippleManager implements View.OnClickListener, Runnable{
    ...
    /**
     * Should be called in the construction method of view to create a CMMaterialRippleDrawable.
     * @param v
     * @param context
     * @param attrs
     * @param defStyleAttr
