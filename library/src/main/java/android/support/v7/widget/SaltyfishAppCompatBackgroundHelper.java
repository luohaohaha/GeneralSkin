 ...
 * Package: android.support.v7.widget<br/>
 * ClassName: CMAppCompatBackgroundHelper<br/>
 * Description: ${TODO} <br/>
 * Date: 2016/10/2 0:44 <br/>
 * <p>
 * Author 昊<br/>
 * Version 1.0<br/>
 * since JDK 1.6<br/>
...
public class SaltyfishAppCompatBackgroundHelper {
    ...
    public SaltyfishAppCompatBackgroundHelper(View view) {
        mView = view;
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            if (a.hasValue(android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_android_background)) {
                mBackgroundResId = a.getResourceId(
                        android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_android_background, -1);
            ...
            if (a.hasValue(android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_backgroundTint)) {
                ViewCompat.setBackgroundTintList(mView,
                        a.getColorStateList(android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_backgroundTint));
            }
            if (a.hasValue(android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(mView,
                        DrawableUtils.parseTintMode(
                                a.getInt(android.support.v7.appcompat.R.styleable.ViewBackgroundHelper_backgroundTintMode, -1),
                                null));
            }
        } finally {
            a.recycle();
